...
parser.add_argument('--data', default='ITS', choices=['ITS', 'OTS', 'Haze4k', 'Dense-Haze', 'NH-HAZE', 
                    'SateHaze1k-Thin', 'SateHaze1k-Moderate', 'SateHaze1k-Thick', 'RESIDE-6K'], type=str, help='dataset')               
parser.add_argument(
...
input_dir = os.path.join(args.input_dir, args.data, 'test', 'hazy')
