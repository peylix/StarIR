...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='./Datasets/LOL-v2/Synthetic/Test/Normal', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='./results/lol-v2s', help='Path to restored images')
