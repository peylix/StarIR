...
parser.add_argument('--output_dir', default='./results/lol-v2s',
                    type=str, help='Directory for output')
parser.add_argument(
    '--opt', type=str, default='./Options/lol-v2s.yml', help='Path to option YAML file.')
parser.add_argument('--weights', default='./pretrained_models/StarIR-LOLV2-Syn.pth',
                    type=str, help='Path to weights')
parser.add_argument('--input_dir', default='./Datasets/', type=str, help='Directory of validation images')
parser.add_argument('--data', default='LOL-v2/Synthetic', type=str, help='dataset')
...
input_dir = os.path.join(args.input_dir, args.data, 'Test', 'Low')
target_dir = os.path.join(args.input_dir, args.data, 'Test', 'Normal')
...
target_paths = natsorted(glob(os.path.join(
    target_dir, '*.png')) + glob(os.path.join(target_dir, '*.jpg')) + glob(os.path.join(target_dir, '*.tif')))
