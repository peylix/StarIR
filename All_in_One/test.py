...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path', type=str, default="StarIR_results-3d/", help='output save path')
    parser.add_argument('--ckpt_name', type=str, default="StarIR-AIO-3D.ckpt", help='checkpoint save path')
    ...
    net  = StarIRModel().load_from_checkpoint(ckpt_path).cuda()
    net.eval()
