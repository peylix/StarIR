...
def pad_input(input_,img_multiple_of=32):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_path', type=str, default="demo/degraded/", help='save path of test images, can be directory or an image')
    parser.add_argument('--output_path', type=str, default="demo/restored/", help='output save path')
    parser.add_argument('--ckpt_name', type=str, default="StarIR-AIO-5D.ckpt", help='checkpoint save path')
    ...
    net  = StarIRModel().load_from_checkpoint(ckpt_path).to(device)
    net.eval()
